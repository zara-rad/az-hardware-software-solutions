      ...
      <main className="relative flex-grow py-24 px-6 max-w-4xl mx-auto z-10">
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed">
            ...
            <strong>{t("impressum.address")}</strong> Musterstraße 12, 10115 Berlin, Germany <br />
...
//               completeness, accuracy, or timeliness of the content provided.
//               We are responsible for our own content on these pages according
//               to general laws but are not obligated to monitor transmitted or
...
//             </h3>
//             <p>
//               All texts, images, logos, and other content on this website are
//               subject to copyright. Any reproduction, processing, distribution,
//               or commercialization of such material beyond the scope of
//               copyright law requires prior written consent from the author or
//               creator.
//             </p>
//           </div>
...
//               We have no influence on the content of those websites and
