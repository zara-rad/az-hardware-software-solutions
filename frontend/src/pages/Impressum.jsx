...
export default function Impressum() {
  ...
  return (
    <motion.div
      ...
      className="relative min-h-screen flex flex-col bg-gradient-to-b from-[#0d1117] via-[#101a25] to-[#0d1117] text-white overflow-hidden"
    >
      ...
      <main className="relative flex-grow py-24 px-6 max-w-4xl mx-auto z-10">
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed">
            ...
            <strong>{t("impressum.address")}</strong>
            Berlin, Germany <br />
