  ...
  return (
    ...
    >
      ...
      <section className="relative z-10 flex flex-col items-center justify-center text-center h-[40vh] min-h-[300px] px-6">
        <MonitorCheck className="w-16 h-16 text-gray-400 mb-4" />
        ...
        >
          {t("it.workstationSetup.title")}
        </motion.h1>

        <p className="text-gray-400 max-w-2xl">
          {t("it.workstationSetup.subtitle")}
        </p>
      </section>
      ...
      <main className="relative z-10 flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto px-6 py-16 gap-10">
        ...
        >
          <p>{t("it.workstationSetup.desc1")}</p>

          <ul className="list-disc list-inside space-y-2 text-gray-400">
            <li>{t("it.workstationSetup.point1")}</li>
            <li>{t("it.workstationSetup.point2")}</li>
            <li>{t("it.workstationSetup.point3")}</li>
          </ul>
          ...
          <div className="pt-6">
            ...
            >
              <ArrowLeft className="w-5 h-5" /> {t("it.workstationSetup.back")}
            </Link>
          </div>
        </motion.div>
         {/* IMAGE right */}
      ...
      >
        <h2 className="text-2xl font-bold mb-4 text-gray-400">
          {t("it.workstationSetup.ctaTitle")}
        </h2>
        <p className="text-gray-400 mb-6">{t("it.workstationSetup.ctaDesc")}</p>
        <a
          href="/contact"
        ...
        >
          {t("it.workstationSetup.ctaButton")}
        </a>
      </motion.div>
    </motion.div>
  );
