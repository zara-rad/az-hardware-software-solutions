  ...
  return (
    ...
    >
      ...
      <main className="relative z-10 flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto px-6 py-16 gap-10">
        ...
        >
          <img
            src="/images/services/sales1.png"
 ...
 {/* CTA */}
      ...
      >
        <h2 className="text-2xl font-bold mb-4 text-gray-400">
          {t("hardware.deviceSales.ctaTitle")}
        </h2>
        <p className="text-gray-400 mb-6">{t("hardware.deviceSales.ctaDesc")}</p>
        <a
          href="/contact"
        ...
        >
          {t("hardware.deviceSales.ctaButton")}
        </a>
      </motion.div>
    </motion.div>
  );
