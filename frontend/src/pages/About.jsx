...
export default function About() {
  return (
    <div className="relative flex flex-col text-white overflow-hidden min-h-screen bg-transparent">
      ...
      {/* 🔹 محتوای اصلی */}
      <main className="relative z-10 flex-grow max-w-6xl mx-auto px-6 pb-12 space-y-12">
        {/* توضیحات اصلی */}
        <motion.div
          ...
          className="bg-[#0b121a]/70 backdrop-blur-lg p-8 md:p-10 rounded-2xl border border-gray-800 shadow-[0_0_20px_rgba(0,0,0,0.4)]"
        >
        ...
        <div className="grid md:grid-cols-2 gap-6 pb-8">
          {[
            ...
            <motion.div
              ...
              className="relative group bg-[#0b121a]/70 backdrop-blur-md rounded-2xl p-8 border border-gray-800 hover:shadow-[0_0_25px_rgba(34,197,94,0.25)] transition-all duration-500"
            >
              <div
